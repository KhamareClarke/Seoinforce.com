...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    void emitFleetIngest({
      event_type: 'lead',
      summary: `Consultation booking: ${name} (${email})`,
      payload: { name, email, phone, source: 'consultation_booking' },
    });
